 ...
 */
angular.module( 'ngBoilerplate.business', [
  'ui.router',
  'plusOne',
  'ngCookies'
])
 ...
 */
.controller( 'BusinessCtrl', function HomeController( $scope, Facebook, $state, $http, $cookieStore ) {
  ...
  // $scope.userID = $state.current.data.userID;
  ...
  $scope.login = function() {
    ...
    }, {scope: 'email,user_likes,user_location,user_friends,manage_pages'});
  };
